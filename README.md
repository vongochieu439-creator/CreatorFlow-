...
- 分区工作台：按创作台、AI策略、质检评分、发布交付拆分功能，避免单页信息拥挤。
- 一份主稿，多平台自动适配。
...
- `BilibiliSubmissionPublisher`：后续可接创作中心投稿流程。
- `ManualAssistPublisher`：对暂未开放接口的平台提供复制、导出、人工确认的半自动发布。
